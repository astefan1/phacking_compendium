...
sim.statAnalysisHack <- function(nobs.group, strategy = "firstsig", effect = 0, heterogeneity = 0, alternative = "two.sided", alpha = 0.05, iter = 1000, shinyEnv = FALSE, empirical = FALSE){

  # Simulate as many datasets as desired iterations
  dat <- list()
  for(i in 1:iter){
    dat[[i]] <- .sim.data(nobs.group = nobs.group, effect = effect,
