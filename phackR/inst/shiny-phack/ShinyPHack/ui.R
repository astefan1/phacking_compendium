...
.rateBox <- function(hackOutput, origOutput){
  box(width=6, status = "primary",
      h4("Significant-result rate (p-hacked)"),
      textOutput(hackOutput),
      h4("Significant-result rate (original)"),
      textOutput(origOutput))
}

.effectInputs <- function(effectId, heterogeneityId, scaleLabel){
  tagList(
    numericInput(effectId,
                 label = paste0("Mean true effect (", scaleLabel, ")"),
                 value = 0,
                 step = 0.1),
    numericInput(heterogeneityId,
                 label = paste0("Between-study heterogeneity (", scaleLabel, ")"),
                 value = 0,
                 min = 0,
                 step = 0.1)
  )
...
sidebar <- dashboardSidebar(
  sidebarMenu(
    ...
    menuItem("Outlier Exclusion", tabName = "outlierExclusion",
             icon = icon("stats",lib = "glyphicon")),
    menuItem("Control Covariates", tabName = "exploitCovariates",
             icon = icon("stats",lib = "glyphicon")),
    menuItem("Scale Redefinition", tabName = "compositeScores",
             icon = icon("stats",lib = "glyphicon")),
    menuItem("Variable Transformation", tabName = "variableTransformation",
             icon = icon("stats",lib = "glyphicon")),
    menuItem("Discretizing", tabName = "exploitCutoffs",
             icon = icon("stats",lib = "glyphicon")),
    menuItem("Exploit Alt. Hyp. Tests", tabName = "statAnalysis",
             icon = icon("stats",lib = "glyphicon")),
  ...
  tabItems(
    ...
    tabItem(tabName = "compositeScores",
            ...
            fluidRow(column(width=8,
                            fixedRow(box(width=12, status = "primary",
                                         plotOutput("compScoresPlot"))),
                            fixedRow(column(width=3,
                                            HTML("")),
                                     .rateBox("compScoresFPHack", "compScoresFPOrig")),
                            fixedRow(box(width=6, status = "primary",
                                         plotOutput("compScoresPlot4")),
                                     box(width=6, status = "primary",
                                         plotOutput("compScoresPlot5")))),
                     column(width=4,
                            box(width=12, status = "primary", height=840, background = "navy",
                                ...
                                .effectInputs("effectCompScores", "heterogeneityCompScores", "Fisher-z scale"),
    ...
    tabItem(tabName = "exploitCovariates",
            ...
            fluidRow(column(width=8,
                            fixedRow(box(width=12, status = "primary",
                                         plotOutput("expCovPlot"))),
                            fixedRow(column(width=3,
                                            HTML("")),
                                     .rateBox("expCovFPHack", "expCovFPOrig")),
                            fixedRow(box(width=6, status = "primary",
                                         plotOutput("expCovPlot4")),
                                     box(width=6, status = "primary",
                                         plotOutput("expCovPlot5")))),
                     column(width=4,
                            box(width=12, status="primary", height=890, background="navy",
                                h4("Simulation settings"),
                                ...
                                .effectInputs("effectExpCov", "heterogeneityExpCov", "standardized mean-difference scale"),
    ...
    tabItem(tabName = "exploitCutoffs",
            ...
            fluidRow(column(width=8,
                            fixedRow(box(width=12, status = "primary",
                                         plotOutput("expCutPlot"))),
                            fixedRow(column(width=3,
                                            HTML("")),
                                     .rateBox("expCutFPHack", "expCutFPOrig")),
                            fixedRow(box(width=6, status = "primary",
                     ...
                     column(width=4,
                            box(width=12, status="primary", height=890, background="navy",
                                ...
                                .effectInputs("effectExpCut", "heterogeneityExpCut", "Fisher-z scale"),
    ...
    tabItem(tabName = "favorableImputation",
            ...
            fluidRow(column(width=8,
                            fixedRow(box(width=12, status = "primary",
                                         plotOutput("favImpPlot"))),
                            fixedRow(column(width=3,
                                            HTML("")),
                                     .rateBox("favImpFPHack", "favImpFPOrig")),
                            fixedRow(box(width=6, status = "primary",
                                         plotOutput("favImpPlot4")),
                                     box(width=6, status = "primary",
                                         plotOutput("favImpPlot5")))),
                     column(width=4,
                            box(width=12, status="primary", height=900, background="navy",
                                h4("Simulation settings"),
                                ...
                                .effectInputs("effectfavImp", "heterogeneityfavImp", "Fisher-z scale"),
    ...
    tabItem(tabName = "incorrectRounding",
            ...
            fluidRow(column(width=8,
                            fixedRow(box(width=12, status = "primary",
                                         plotOutput("roundingPlot"))),
                            fixedRow(column(width=3,
                                            HTML("")),
                                     .rateBox("roundingFPHack", "roundingFPOrig")),
                            fixedRow(box(width=6, status = "primary",
                     ...
                     column(width=4,
                            box(width=12, status="primary", height=890, background="navy",
                                ...
                                radioButtons("altRounding", label = "Direction of the test", choiceNames = list("Two-sided", "One-sided (positive effect: treatment > control)"), choiceValues = list("two.sided", "greater")),
                                .effectInputs("effectRounding", "heterogeneityRounding", "standardized mean-difference scale"),
    ...
    tabItem(tabName = "optionalStopping",
            ...
            fluidRow(column(width=8,
                            fixedRow(box(width=12, status = "primary",
                                         plotOutput("optStopPlot"))),
                            fixedRow(column(width=3,
                                            HTML("")),
                                     .rateBox("optStopFPHack", "optStopFPOrig")),
                            fixedRow(box(width=6, status = "primary",
                     ...
                     column(width=4,
                            box(width=12, status="primary", height=890, background="navy",
                                ...
                                radioButtons("altOptStop", label = "Direction of the test", choiceNames = list("Two-sided", "One-sided (positive effect: treatment > control)"), choiceValues = list("two.sided", "greater")),
                                .effectInputs("effectOptStop", "heterogeneityOptStop", "standardized mean-difference scale"),
    ...
    tabItem(tabName = "outlierExclusion",
            ...
            fluidRow(column(width=8,
                            fixedRow(box(width=12, status = "primary",
                                         plotOutput("outExclPlot"))),
                            fixedRow(column(width=3,
                                            HTML("")),
                                     .rateBox("outExclFPHack", "outExclFPOrig")),
                            fixedRow(box(width=6, status = "primary",
                     ...
                     column(width=4,
                            box(width=12, status="primary", height=890, background="navy",
                                ...
                                .effectInputs("effectOutExcl", "heterogeneityOutExcl", "Fisher-z scale"),
            ...
            fluidRow(column(width=8,
                     ...
                     column(width=4,
                            box(width=12, status="primary", height=890, background="navy",
                                ...
                                radioButtons("altSRDV", label = "Direction of the test", choiceNames = list("Two-sided", "One-sided (positive effect: treatment > control)"), choiceValues = list("two.sided", "greater")),
                                .effectInputs("effectSRDV", "heterogeneitySRDV", "standardized mean-difference scale"),
            ...
            fluidRow(column(width=8,
                     ...
                     column(width=4,
                            box(width=12, status="primary", height=890, background="navy",
                                ...
                                radioButtons("altSRIV", label = "Direction of the test", choiceNames = list("Two-sided", "One-sided (positive effect: treatment > control)"), choiceValues = list("two.sided", "greater")),
                                .effectInputs("effectSRIV", "heterogeneitySRIV", "standardized mean-difference scale"),
    ...
    tabItem(tabName = "statAnalysis",
            ...
            fluidRow(column(width=8,
                            fixedRow(box(width=12, status = "primary",
                                         plotOutput("statAnalysisPlot"))),
                            fixedRow(column(width=3,
                                            HTML("")),
                                     .rateBox("statAnalysisFPHack", "statAnalysisFPOrig"))),
                     column(width=4,
                            box(width=12, status="primary", height=890, background="navy",
                                h4("Simulation settings"),
                                numericInput("nobsStatAnalysis", label = "Number of observations", value = 30, min = 10, max = 1000),
                                radioButtons("altStatAnalysis", label = "Direction of the test", choiceNames = list("Two-sided", "One-sided (positive effect: treatment > control)"), choiceValues = list("two.sided", "greater")),
                                .effectInputs("effectStatAnalysis", "heterogeneityStatAnalysis", "standardized mean-difference scale"),
    ...
    tabItem(tabName = "subgroupAnalysis",
            ...
            fluidRow(column(width=8,
                            ...
                            fixedRow(column(width=3,
                                            HTML("")),
                                     .rateBox("subgroupFPHack", "subgroupFPOrig")),
                            fixedRow(box(width=6, status = "primary",
                     ...
                     column(width=4,
                            box(width=12, status="primary", height=890, background="navy",
                                ...
                                radioButtons("altSubgroup", label = "Direction of the test", choiceNames = list("Two-sided", "One-sided (positive effect: treatment > control)"), choiceValues = list("two.sided", "greater")),
                                .effectInputs("effectSubgroup", "heterogeneitySubgroup", "standardized mean-difference scale"),
    ...
    tabItem(tabName = "variableTransformation",
            ...
            fluidRow(column(width=8,
                            fixedRow(box(width=12, status = "primary",
                                         plotOutput("varTransPlot"))),
                            fixedRow(column(width=3,
                                            HTML("")),
                                     .rateBox("varTransFPHack", "varTransFPOrig")),
                            fixedRow(box(width=6, status = "primary",
                     ...
                     column(width=4,
                            box(width=12, status="primary", height=890, background="navy",
                                ...
                                .effectInputs("effectVarTrans", "heterogeneityVarTrans", "Fisher-z scale"),
