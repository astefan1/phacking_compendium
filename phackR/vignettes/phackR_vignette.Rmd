...
set.seed(1234)
sim.multDVhack(nobs.group = 30, nvar = 5, r = 0.3, effect = 0, heterogeneity = 0,
               strategy = "smallest",
...
```{r incorrectRounding}
set.seed(1234)
sim.roundhack(roundinglevel = 0.06, effect = 0, heterogeneity = 0, iter = 10,
...
```{r subgroupAnalysis}
set.seed(1234)
sim.subgroupHack(nobs.group = 30, nsubvars = 3, effect = 0, heterogeneity = 0,
                 alternative = "two.sided",
...
```{r compositeScores}
set.seed(1234)
sim.compscoreHack(nobs = 30, ncompv = 5, rcomp = 0.7, effect = 0,
                  heterogeneity = 0, ndelete = 3, 
                  strategy = "smallest", alpha = 0.05, iter = 10)
```
...
set.seed(1234)
sim.varTransHack(nobs = 30, transvar = "xy", effect = 0, heterogeneity = 0,
                 strategy = "smallest", 
                 alpha = 0.05, iter = 10)
```
...
```{r statAnalysis}
set.seed(1234)
sim.statAnalysisHack(nobs.group = 30, effect = 0, heterogeneity = 0,
                     strategy = "smallest",
...
set.seed(1234)
sim.impHack(nobs = 30, missing = 0.2, which = c(1:10), effect = 0,
            heterogeneity = 0, strategy = "smallest", 
            alpha = 0.05, iter = 10)
```
