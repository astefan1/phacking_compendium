...
test_that("Selective Reporting of DV works", {
  ...
  phack.ambitious <- sim.multDVhack(nobs.group = c(30, 30), nvar = 5, r = 0.3, strategy = "smallest.sig", iter = 100, alternative = "two.sided", alpha = 0.05, seed = 2345)
  phack.normal <- sim.multDVhack(nobs.group = c(30, 30), nvar = 5, r = 0.3, strategy = "firstsig", iter = 100, alternative = "two.sided", alpha = 0.05, seed = 2345)
  ...
  phack.ambitious2 <- sim.multDVhack(nobs.group = c(30, 30), nvar = 15, r = 0.3, strategy = "smallest", iter = 100, alternative = "two.sided", alpha = 0.05, seed = 2345)
  phack.normal2 <- sim.multDVhack(nobs.group = c(30, 30), nvar = 15, r = 0.3, strategy = "firstsig", iter = 100, alternative = "two.sided", alpha = 0.05, seed = 2345)
...
test_that("Selective Reporting of IV works", {
  ...
  phack.ambitious <- sim.multIVhack(nobs.group = 30, nvar = 5, r = 0.3, strategy = "smallest.sig", iter = 100, alternative = "two.sided", alpha = 0.05, seed = 1234)
  phack.normal <- sim.multIVhack(nobs.group = 30, nvar = 5, r = 0.3, strategy = "firstsig", iter = 100, alternative = "two.sided", alpha = 0.05, seed = 1234)
  ...
  phack.ambitious2 <- sim.multIVhack(nobs.group = c(30, 30), nvar = 15, r = 0.3, strategy = "smallest", iter = 100, alternative = "two.sided", alpha = 0.05, seed = 2345)
  phack.normal2 <- sim.multIVhack(nobs.group = c(30, 30), nvar = 15, r = 0.3, strategy = "firstsig", iter = 100, alternative = "two.sided", alpha = 0.05, seed = 2345)
  expect_gt(length(which(phack.ambitious2[,1] < 0.05)), length(which(phack.ambitious[,1] < 0.05)))
  expect_gt(length(which(phack.normal2[,1] < 0.05)), length(which(phack.normal[,1] < 0.05)))
...
test_that("Outlier Exclusion works", {
  ...
  outexcl1 <- sim.outHack(nobs = 20, which = "random", strategy = "firstsig", alpha = 0.05, iter = 100, seed = 1234)
  outexcl2 <- sim.outHack(nobs = 20, which = "random", strategy = "smallest.sig", alpha = 0.05, iter = 100, seed = 1234)
...
test_that("Exploiting Covariates works", {
  ...
  covhack1 <- sim.covhack(nobs.group = 20, ncov = 3, rcov = 0.1, rcovdv = 0.6, interactions = FALSE, strategy = "firstsig", alpha = 0.05, iter = 100, seed = 1234)
  covhack2 <- sim.covhack(nobs.group = 20, ncov = 3, rcov = 0.1, rcovdv = 0.6, interactions = FALSE, strategy = "smallest.sig", alpha = 0.05, iter = 100, seed = 1234)
...
test_that("Subgroup Analyses work", {
  ...
  subgrhack1 <- sim.subgroupHack(nobs.group = 30, nsubvars = 3, alternative = "two.sided", strategy = "firstsig", alpha = 0.05, iter = 100, seed = 1234)
  subgrhack2 <- sim.subgroupHack(nobs.group = 30, nsubvars = 3, alternative = "two.sided", strategy = "smallest.sig", alpha = 0.05, iter = 100, seed = 1234)
...
test_that("Scale Redefinition works", {
  ...
  scaledef1 <- sim.compscoreHack(nobs = 30, ncompv = 10, rcomp = 0.5, ndelete = 5, strategy = "firstsig", alpha = 0.05, iter = 100, seed = 1234)
  scaledef2 <- sim.compscoreHack(nobs = 30, ncompv = 10, rcomp = 0.5, ndelete = 5, strategy = "smallest.sig", alpha = 0.05, iter = 100, seed = 1234)
...
test_that("Selective reporting of effects works", {
  ...
  selR1 <- sim.selectEffects(nobs = 30, niv = 3, riv = 0.1, interactions = TRUE, strategy = "firstsig", alpha = 0.05, iter = 100, seed = 1234)
  selR2 <- sim.selectEffects(nobs = 30, niv = 3, riv = 0.1, interactions = TRUE, strategy = "smallest.sig", alpha = 0.05, iter = 100, seed = 1234)
...
test_that("Exploiting arbitraray cutoffs works", {
  ...
  arbitCutoff1 <- sim.cutoffHack(nobs = 30, strategy = "firstsig", alpha = 0.05, iter = 100, seed = 1234)
  arbitCutoff2 <- sim.cutoffHack(nobs = 30, strategy = "smallest.sig", alpha = 0.05, iter = 100, seed = 1234)
...
test_that("Exploiting statistical analysis options works", {
  ...
  arbitStats1 <- sim.statAnalysisHack(nobs.group = 30, strategy = "firstsig", alternative = "two.sided", alpha = 0.05, iter = 100, seed = 1234)
  arbitStats2 <- sim.statAnalysisHack(nobs = 30, strategy = "smallest.sig", alternative = "two.sided", alpha = 0.05, iter = 100, seed = 1234)
...
test_that("Exploiting variable transformations works", {
  ...
  varT1 <- sim.varTransHack(nobs = 30, transvar = "xy", strategy = "firstsig", alpha = 0.05, iter = 100, seed = 1234)
  varT2 <- sim.varTransHack(nobs = 30, transvar = "xy", strategy = "smallest.sig", alpha = 0.05, iter = 100, seed = 1234)
...
test_that("Exploiting missing value imputation works", {
  ...
  misval1 <- sim.impHack(nobs = 30, missing = 0.1, which = "random", strategy = "firstsig", alpha = 0.05, iter = 100, seed = 1234)
  misval2 <- sim.impHack(nobs = 30, missing = 0.1, which = "random", strategy = "smallest.sig", alpha = 0.05, iter = 100, seed = 1234)
